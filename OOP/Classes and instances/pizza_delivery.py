class PizzaDelivery:
    ...
    def add_extra(self, ingredient: str, quantity: int, ingredient_price: float):
        ...
        filtered_ingredients = [i for i,v in self.ingredients.items() if i == ingredient]
    ...
    def make_order(self):
        ...
        return f'You\'ve ordered pizza {self.name} prepared with {PizzaDelivery.formating(self)} and the price will be {self.price}lv.'
